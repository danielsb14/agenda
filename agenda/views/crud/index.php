...
<form role="form" method="post" action="crud/php/agregar.php">
  ...
  <div class="form-group">
    ...
    <input type="tel" class="form-control" name="phone" placeholder="XXX XXXXXX" >
  </div>
...
<?php include "crud/php/tabla.php"; ?>
</div>
</div>
</div>
